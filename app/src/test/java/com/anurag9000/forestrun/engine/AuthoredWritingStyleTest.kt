...
class AuthoredWritingStyleTest {
    ...
    private val sourceFiles = listOf(
        ...
        "app/src/main/java/com/anurag9000/forestrun/engine/StoryFragmentSystem.kt",
        "app/src/main/java/com/anurag9000/forestrun/ui/RestQuoteManager.kt",
        "app/src/main/java/com/anurag9000/forestrun/engine/RunFlavorPresentation.kt"
    )
