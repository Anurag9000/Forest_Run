...
import com.anurag9000.forestrun.entities.animals.*
import com.anurag9000.forestrun.entities.birds.*
import com.anurag9000.forestrun.entities.flora.*
import com.anurag9000.forestrun.entities.trees.*
        ...
        return when (type) {
            ...
            EntityType.DOG      -> Dog(
                ...
                isBuddy = when (variant) {
                    ...
                    else -> kotlin.random.Random.nextFloat() < com.anurag9000.forestrun.engine.RelationshipArcSystem.dogBuddyChance(context)
                }
            )
        }
    }
