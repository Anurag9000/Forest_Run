...
enum class Biome(
    ...
    MEADOW(
        ...
        skyTopColour = PackedArgb.rgb(144, 210, 255),
        skyBottomColour = PackedArgb.rgb(220, 240, 255),
        groundColour = PackedArgb.rgb(80, 160, 80),
        midFoliageColour = PackedArgb.rgb(60, 140, 60),
    ...
    ORCHARD(
        ...
        skyTopColour = PackedArgb.rgb(255, 200, 220),
        skyBottomColour = PackedArgb.rgb(255, 230, 200),
        groundColour = PackedArgb.rgb(100, 180, 80),
        midFoliageColour = PackedArgb.rgb(180, 100, 120),
    ...
    ANCIENT_GROVE(
        ...
        skyTopColour = PackedArgb.rgb(60, 120, 80),
        skyBottomColour = PackedArgb.rgb(30, 80, 50),
        groundColour = PackedArgb.rgb(50, 100, 50),
        midFoliageColour = PackedArgb.rgb(30, 80, 40),
    ...
    DUSK_CANYON(
        ...
        skyTopColour = PackedArgb.rgb(200, 80, 40),
        skyBottomColour = PackedArgb.rgb(255, 150, 80),
        groundColour = PackedArgb.rgb(160, 100, 60),
        midFoliageColour = PackedArgb.rgb(180, 80, 40),
    ...
    NIGHT_FOREST(
        ...
        skyTopColour = PackedArgb.rgb(10, 10, 40),
        skyBottomColour = PackedArgb.rgb(20, 20, 60),
        groundColour = PackedArgb.rgb(20, 40, 30),
        midFoliageColour = PackedArgb.rgb(10, 30, 20),
