...
- Partial: named relationship arcs now exist in stronger runtime form for Cat, Fox, Wolf, Dog, Owl, and Eagle, with persisted stages, stage-aware dialogue/payoff, bonded Garden return hooks, milestone keepsake rewards, featured home-presence carry-home lines, bond-specific milestone reactions, and warmer repeated-kindness familiarity tiers that now read more personally during ordinary encounters.
