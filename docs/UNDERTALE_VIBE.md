...
- Partial: named relationship arcs now exist in baseline runtime form for Cat, Fox, Wolf, Dog, Owl, and Eagle, with persisted stages, stage-aware dialogue/payoff, bonded Garden return hooks, milestone keepsake rewards, featured home-presence carry-home lines, and bond-specific milestone reactions.
