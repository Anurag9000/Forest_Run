...
| 22 | Partial | canonical lifecycle, run-summary carryover, stronger rest carry-home preview, sanctuary-derived recovery/homecoming framing, stronger cold-start home-sign atmosphere, and authored stand/ready launch copy now exist; full authored recovery richness and final launch feel still incomplete |
...
- PARTIAL: startup, rest, and Garden now share a baseline authored session-arc copy layer plus sanctuary-derived arrival badges, stronger home-sign atmosphere, carried-home ambience cues, authored stand/ready launch wording, a guided first-30-seconds onboarding/readability pass, a more staged restorative rest panel with run-kept/homeward framing, and a more varied post-run reflection mix; finish full sanctuary-grade atmosphere, device-proof feel tuning, and remaining authored depth
