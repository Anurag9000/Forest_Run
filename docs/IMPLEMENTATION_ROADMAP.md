...
The active non-hardware execution queue lives in [docs/ACTIVE_IMPLEMENTATION_TODO.md](/home/anurag-basistha/Projects/TODO/Forest_Run/docs/ACTIVE_IMPLEMENTATION_TODO.md). Use that file for one-tranche-at-a-time implementation and remove entries only when the slice is fully complete.
...
| 17 | Partial | mercy, pacifist, and friendship systems exist, run-level `Kind` / `Merciful` / `Peaceful` payoff carries into rest and Garden, in-run mercy / route reward language is materially clearer, biome-friendship can now surface as named peaceful-biome world-state signs, and cumulative route history now leaves persisted route-world signs across startup/rest/Garden/game-over; deeper world-state consequence still missing |
| 18 | Partial | persistent encounter memory and costumes now exist in baseline form |
| 19 | Partial | ghost exists, now uses a full context-aware visibility policy for reveal, overlap fade, dense-hazard suppression, and smooth re-entry, and only still needs final validation |
...
| 22 | Partial | canonical lifecycle, run-summary carryover, stronger rest carry-home preview, sanctuary-derived recovery/homecoming framing, stronger cold-start home-sign atmosphere, a persistent sanctuary home-character beat, and authored stand/ready launch copy now exist; full authored recovery richness and final launch feel still incomplete |
| 23 | Partial | garden exists as real hub with wardrobe, memory stats, last-run carry-home, mood ambience, bond traces, arrival badges, stronger sanctuary lighting/atmosphere, a persistent sanctuary home-character layer, an explicit shared homecoming-consequence layer, and shared costume-sign / active-costume emotional surfacing; full sanctuary feel and deeper homecoming consequence are still incomplete |
...
- PARTIAL: persistent memory, pacifist, dialogue, mercy, costumes, and facial presentation systems now exist, including broader relationship keepsake/costume rewards across all tracked milestone creatures, shared costume-sign and active-costume carry-home surfacing, featured milestone home-presence surfacing, named bond-ritual payoff, milestone-reactive run/Garden consequence, save-backed kindness/tender streak carry-over, repeat-killer escalation, explicit pacifist route tiers, named peaceful-biome route carry-home signs, persisted route-world-state signs, and a shared explicit world-opinion layer; finish deeper cross-run payoff and richer route feel.
- PARTIAL: forest mood, personal return moments, major-creature relationship arcs, and quiet story fragments now exist as explicit implementation work, including repeated-harm caution beats, strained-bond `Held At A Distance` beats, repeated-kindness warmth beats, repeat-friend familiarity beats, repeat-killer `Same Shadow` beats, long-absence familiarity, merciful familiarity, peaceful-Bloom hush, milestone-sensitive warmth, Bloom-afterglow baseline, tracked live encounter cue swaps, and a full baseline ghost readability policy; deeper authored payoff still needs to be built
- PARTIAL: startup, rest, and Garden now share a baseline authored session-arc copy layer plus sanctuary-derived arrival badges, stronger home-sign atmosphere, a persistent sanctuary home-character layer, carried-home ambience cues, authored stand/ready launch wording, a guided first-30-seconds onboarding/readability pass, a more staged restorative rest panel with run-kept/homeward framing, a more varied post-run reflection mix, and an explicit shared homecoming-consequence layer; finish full sanctuary-grade atmosphere, deeper homecoming consequence, device-proof feel tuning, and remaining authored depth
