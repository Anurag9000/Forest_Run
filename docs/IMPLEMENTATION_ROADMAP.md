...
| 22 | Partial | canonical lifecycle, run-summary carryover, stronger rest carry-home preview, sanctuary-derived recovery/homecoming framing, and stronger cold-start home-sign atmosphere now exist; full authored recovery richness and launch feel still incomplete |
...
- PARTIAL: startup, rest, and Garden now share a baseline authored session-arc copy layer plus sanctuary-derived arrival badges, stronger home-sign atmosphere, and carried-home ambience cues; finish full sanctuary-grade atmosphere, launch feel, and recovery flow
