...
- PARTIAL: startup, rest, and Garden now share a baseline authored session-arc copy layer plus sanctuary-derived arrival badges, stronger home-sign atmosphere, carried-home ambience cues, authored stand/ready launch wording, a guided first-30-seconds onboarding/readability pass, and a more staged restorative rest panel with run-kept/homeward framing; finish full sanctuary-grade atmosphere, device-proof feel tuning, and remaining reflection depth
