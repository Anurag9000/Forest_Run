...
| 23 | Partial | garden exists as real hub with wardrobe, memory stats, last-run carry-home, mood ambience, bond traces, arrival badges, stronger sanctuary lighting/atmosphere, a persistent sanctuary home-character layer, and an explicit shared homecoming-consequence layer; full sanctuary feel and deeper homecoming consequence are still incomplete |
