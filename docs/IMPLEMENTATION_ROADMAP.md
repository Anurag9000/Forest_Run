...
| 23 | Partial | garden exists as real hub with wardrobe, memory stats, last-run carry-home, mood ambience, bond traces, arrival badges, stronger sanctuary lighting/atmosphere, and a persistent sanctuary home-character layer; full sanctuary feel and deeper homecoming consequence are still incomplete |
...
- PARTIAL: startup, rest, and Garden now share a baseline authored session-arc copy layer plus sanctuary-derived arrival badges, stronger home-sign atmosphere, a persistent sanctuary home-character layer, carried-home ambience cues, authored stand/ready launch wording, a guided first-30-seconds onboarding/readability pass, a more staged restorative rest panel with run-kept/homeward framing, and a more varied post-run reflection mix; finish full sanctuary-grade atmosphere, deeper homecoming consequence, device-proof feel tuning, and remaining authored depth
