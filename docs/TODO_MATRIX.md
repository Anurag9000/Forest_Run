...
- DONE: costume overlays and wardrobe flow now include milestone-earned Cat/Fox/Wolf/Dog/Owl/Eagle wardrobe rewards, relationship-aware unlock messaging, featured reward/cosmetic pairing, first-class startup/rest/Garden costume signs, and active-costume emotional carry-over instead of leaving costume payoff inside the wardrobe panel alone.
...
- PARTIAL: biome-level friendship bonus baseline now escalates into save-visible pacifist route tiers plus named peaceful-biome carry-home, menu/rest/Garden copy, route-sensitive reflections, explicit homecoming consequence chips/cards, and persisted route-world signs so route history leaves a clearer ongoing opinion than the last run alone; deepen the broader sanctuary/world-state consequence further.
