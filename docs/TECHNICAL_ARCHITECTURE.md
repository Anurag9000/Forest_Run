...
- Partial: persistence schema now also carries kindness/tender streak state plus last-run pacifist route tier for cross-run emotional payoff, while repeat-killer escalation is now derived from the persisted hit/tender history.
